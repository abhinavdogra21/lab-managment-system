...
export default function LabStaffDailySchedulePage() {
  ...
  const loadDailySchedule = async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/lab-staff/daily-schedule?date=${dateStr}${labParam}`)
    ...
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        <Button variant="outline" size="sm" asChild>
          <Link href="/lab-staff/dashboard/timetable">
