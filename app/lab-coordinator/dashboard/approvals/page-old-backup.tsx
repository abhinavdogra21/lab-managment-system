...
import { Calendar, Clock, Check, X, ArrowLeft, User, Building, CheckCircle2, Users, ChevronDown, ChevronUp, Package } from 'lucide-react'
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold">Review Lab Booking & Component Requests</h1>
          <p className="text-xs text-muted-foreground">
            {activeTab === 'pending' ? `${pendingItems.length} lab bookings & component requests pending your approval`
