...
CREATE TABLE `component_activity_logs` (
  `id` int NOT NULL AUTO_INCREMENT,
  `entity_type` enum('component_request','component_loan') COLLATE utf8mb4_unicode_ci NOT NULL,
  `entity_id` int DEFAULT NULL,
  `lab_id` int DEFAULT NULL,
  ...
  `actor_role` enum('student','faculty','lab_staff','hod','admin','others','non_teaching') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `password_hash` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `role` enum('student','faculty','lab_staff','hod','admin','others','non_teaching') COLLATE utf8mb4_unicode_ci NOT NULL,
  `department` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `student_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `employee_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping events for database 'lnmiit_lab_management'
--

--
-- Dumping routines for database 'lnmiit_lab_management'
--
...
-- Dump completed on 2025-11-05  0:29:57
